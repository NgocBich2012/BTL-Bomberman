...
public class FileLevelLoader extends LevelLoader {
	...
	public void loadLevel(int level) {
            //??c file c?u hình và l?u tr? ma tr?n ch?a thông tin c?a các ??i t??ng vào m?ng ma tr?n 2 chi?u cho tr??c _map
	...
	public void createEntities() {
        //?? ??c các thông tin trong m?ng _map và hi?n th? trong game
